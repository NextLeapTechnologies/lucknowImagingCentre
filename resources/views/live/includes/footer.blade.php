                        ...
                        <ul class="contact-list list-unstyled">
                            <li>
                                <a href="mailto:provetta@7oroof.com">
                                    <i class="contact-icon icon-email"></i> <span>info@lucknowimagingcentre.com</span>
                                </a>
                            </li>
                            <li>
                                <a href="tel:00201061245741">
                                    <i class="contact-icon icon-phone"></i> <span>(91) 0522-3180995</span>
                                </a>
                            </li>
                        </ul>
                        <p>4/12, Vijayant Khand, Near Kathauta Chauraha, Gomti Nagar, Lucknow, U.P, 226010</p>
                        <a href="{{route('live.pages.contact-us')}}" class="btn btn-white btn-link mr-30">
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="footer-widget-time">
                        ...
                        <ul class="time-list list-unstyled">
                            <li>
                                <span class="day">Mon - Sat:</span><span class="time">9:00 AM - 8:00 PM</span>
                            </li>
                            <li>
                                <span class="day">Sunday</span><span class="time">10:00 AM - 2:00 PM</span>
                            </li>
                        </ul>
