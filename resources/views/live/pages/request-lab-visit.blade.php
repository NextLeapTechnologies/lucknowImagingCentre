...
<head>
    ...
    <title>Request Lab Visit | Lucknow Imaging Centre - "Advanced Diagnostics and Imaging Services for Accurate
        Results"</title>
        ...
        <div class="container">
            <div class="row mb-30">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-8">
                    <h1 class="pagetitle-heading">Request A Lab Visit</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-8">
                    <div class="contact-panel">
                        <form class="contact-panel-form" id="labvisitForm">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="contact-panel-title">Request a Lab Visit</h4>
                                    <p class="contact-panel-desc mb-30">We value your time and convenience. To
                                        streamline your visit and reduce waiting time, we kindly request you to complete
                                        the online form.By filling out the form in advance, you can provide accurate
                                        information and ensure a smooth check-in process upon your arrival. Should you
                                        need any assistance or have any questions, our staff is readily available to
                                        assist you. Thank you for your cooperation in helping us serve you better.
                                    </p>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-10" placeholder="4/12,Vijayant Khand,Near Kathauta Chauraha,"
                                               id="address">
                                ...
                                <div class="col-12">
                                    ...
                                    <button type="submit" class="btn btn-secondary btn-block btn-xhight">
                                        <span>Confirm Your Visit</span> <i class="icon-arrow-right"></i>
                                    </button>
                                </div>
                            </div><!-- /.row -->
                        </form>
